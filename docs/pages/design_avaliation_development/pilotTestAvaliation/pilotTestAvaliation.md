...
|:-:|:-:|
|![Cadastro](./images/cadastro.png)|![Login](./images/login.png)|
...
|:-:|:-:|
|![Eletrônico 1](./images/eletronico1.png)|![Eletrônico 2](./images/eletronico2.png)|

|***Figura 7 - Roupas***|***Figura 8 - Maquiagem***|
|:-:|:-:|
|![Roupa](./images/roupa.png)|![Maquiagem](./images/maquiagem.png)|
...
|:-|:-|
|![Mario](./images/persona1.jpeg)| <ul><li><b>Nome:</b> Mario Moacir</li><li><b>Idade:</b> 22 anos</li><li><b>Profissão:</b> Estudante</li><li><b>Educação:</b> Ensino superior incompleto</li></ul> |
...
Com a avaliação montada, e com o a definição de quais pessoas deverão participar da avaliação, é necessário descrever como será feito a avaliações pelos avalaidores, serão listados as etapas bem como quais observações o avaliador deve ter durante cada uma delas.
...
Para que o avaliador consiga anotar suas observações assim como problemas tanto do site, quanto do usuário em relação às tarefas foi desenvolvido uma tabela para que o mesmo possa descrever todo o processo. Disponivel para dowload abaixo.
